...
class Domain:
    ...
    def __init__(self):
        ...
        self.start_char = ''
        # Ending domain (included in query, must match length)
        self.end_char = ''
        # Combination prefix
        self.prefix = ''
        # Combination suffix
        self.suffix = ''
        # Breakpoint resume URL
        self.resume_url = ''
    ...
    def update_from_dict(self, data):
        ...
        self.end_char = data.get('end_char', self.end_char)
        self.prefix = data.get('prefix', self.prefix)
        self.suffix = data.get('suffix', self.suffix)
        self.resume_url = data.get('resume_url', self.resume_url)
